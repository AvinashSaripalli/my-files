...
//                     </Link> */}
//                     <Link
//   to={`/employee-tasks/${group.partnerCompanyId}`}
//   state={{
//     partnerCompanyName: group.partnerCompanyName,
//     partnerCompanyId: group.partnerCompanyId,
//   }}
            ...
            {groupedData.length > 0 ? (
              groupedData.map((group) => (
                <TableRow key={group.id}>
                  ...
                  <TableCell align="left">
                    <Link
                      to={`/employee/employee-tasks/${group.partnerCompanyId}`}
                      state={{
                        partnerCompanyName: group.partnerCompanyName,
                        partnerCompanyId: group.partnerCompanyId,
                      }}
                  ...
                  <TableCell align="center">{new Date(group.createdOn).toLocaleDateString('en-GB')}</TableCell>
                  <TableCell align="center">
                    <Chip label={group.privacyType} sx={{ width: '100px', minWidth: 'unset' }} />
                  </TableCell>
                  <TableCell align="center">
